...
try:
    import PySpin
    print("Imported, no issues stated")
    sys.path.append("/usr/local/lib")
    sys.path.append('/Users/chris/PyCharmProjects/CSC_Indepenedent/env/lib/python3.8/site-packages')
   
except:
    print("During import, issues stated")
    print("Would you like a report of the issues?")
    if(input() == 'Yes'):
        import PySpin
